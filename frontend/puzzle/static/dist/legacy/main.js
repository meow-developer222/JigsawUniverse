...
function draw_piece_path(ctx, piece) {
    ...
    if (piece.spine_dir[0] !== 0) {
        ...
        ctx.bezierCurveTo(midX - SPINE_WIDTH / 2 - SPINE_OFFSET, midY - SPINE_HEIGHT * piece.spine_dir[0], midX + SPINE_WIDTH / 2 + SPINE_OFFSET, midY - SPINE_HEIGHT * piece.spine_dir[0], midX + SPINE_WIDTH / 2, midY);
    }
    ...
    if (piece.spine_dir[1] !== 0) {
        ...
        ctx.bezierCurveTo(midX + SPINE_HEIGHT * piece.spine_dir[1], midY - SPINE_WIDTH / 2 - SPINE_OFFSET, midX + SPINE_HEIGHT * piece.spine_dir[1], midY + SPINE_WIDTH / 2 + SPINE_OFFSET, midX, midY + SPINE_WIDTH / 2);
    }
    ...
    if (piece.spine_dir[2] !== 0) {
        ...
        ctx.lineTo(midX + SPINE_WIDTH / 2, midY);
        ctx.bezierCurveTo(midX + SPINE_WIDTH / 2 + SPINE_OFFSET, midY + SPINE_HEIGHT * piece.spine_dir[2], midX - SPINE_WIDTH / 2 - SPINE_OFFSET, midY + SPINE_HEIGHT * piece.spine_dir[2], midX - SPINE_WIDTH / 2, midY);
    }
    ...
    if (piece.spine_dir[3] !== 0) {
        ...
        ctx.lineTo(midX, midY + SPINE_WIDTH / 2);
        ctx.bezierCurveTo(midX - SPINE_HEIGHT * piece.spine_dir[3], midY + SPINE_WIDTH / 2 + SPINE_OFFSET, midX - SPINE_HEIGHT * piece.spine_dir[3], midY - SPINE_WIDTH / 2 - SPINE_OFFSET, midX, midY - SPINE_WIDTH / 2);
    }
...
function draw_piece(ctx, piece, image) {
    ...
    ctx.drawImage(image, -piece.imageX - padding, -piece.imageY - padding, IMAGE_WIDTH, IMAGE_HEIGHT);
    ctx.lineWidth = 3;
